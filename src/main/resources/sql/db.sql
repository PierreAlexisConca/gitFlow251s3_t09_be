...
-- ========================================
-- [JOIN 6] Proveedores ACTIVOS 
-- Aprovecha: ix_proveedores_state
-- Muestra solo proveedores con state = 'A',
-- incluyendo sus coordenadas GPS
-- ========================================
SELECT
    p.ruc,
    p.company_name                  AS empresa,
    p.contact_name                  AS contacto,
    p.address                       AS direccion,
    p.email,
    p.cellphone                     AS telefono,
    p.ubicacion.Lat                 AS latitud,
    p.ubicacion.Long                AS longitud,
    p.state                         AS estado
FROM proveedores p
WHERE p.state = 'A'
...
-- ========================================
-- [JOIN 7] Proveedores INACTIVOS
-- Aprovecha: ix_proveedores_state
-- Muestra solo proveedores con state = 'I'
-- ========================================
SELECT
    p.ruc,
    p.company_name                  AS empresa,
